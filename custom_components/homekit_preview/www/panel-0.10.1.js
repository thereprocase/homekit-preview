...
const PANEL_TAG = "homekit-preview-panel-v0101";
const BUILD_LABEL = "0.10.1 · proxy-flow";
const EMPTY_FILTER = {
...
class HomeKitPreviewPanel extends HTMLElement {
  ...
  renderMessage() {
    ...
    return `<div class="notice ${failed ? "error" : "ok"}" role="status" aria-live="polite">${this.escape(this._message)}</div>`;
  }
