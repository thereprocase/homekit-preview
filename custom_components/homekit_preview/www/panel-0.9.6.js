...
const PANEL_TAG = "homekit-preview-panel-v096";
const BUILD_LABEL = "0.9.6 · device-cues";
const EMPTY_FILTER = {
  ...
  renderStyles() {
    return `<style>
      ...
      * { box-sizing: border-box; }
      ...
      .deviceCard { width: 100%; text-align: left; background: var(--hp-surface); color: var(--primary-text-color); border: var(--hp-border); border-radius: var(--hp-radius); padding: 12px; cursor: pointer; border-left: 4px solid transparent; overflow: hidden; }
      ...
      @media (max-width: 620px) {
        ...
        h1 { font-size: 21px; }
        .overviewGrid, .actionSummary, .summaryGrid { grid-template-columns: 1fr; }
        .actionTile { padding: 11px; }
