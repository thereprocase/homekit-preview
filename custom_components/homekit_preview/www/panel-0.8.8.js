...
const PANEL_TAG = "homekit-preview-panel-v088";
const BUILD_LABEL = "0.8.8 · draft-polish";
const EMPTY_FILTER = {
    ...
    return `<style>
      ...
      * { box-sizing: border-box; }
      ...
      @media (max-width: 980px) {
        :host { padding: 14px; }
        .top, .layout, .proxySummary, .draftBar { grid-template-columns: 1fr; }
      ...
      @media (max-width: 620px) {
        ...
        .filterReset, .bridgeActions button, .actionRow button, .draftActions button { width: 100%; white-space: normal; }
        .draftActions { justify-content: stretch; }
