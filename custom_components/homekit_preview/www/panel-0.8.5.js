...
const PANEL_TAG = "homekit-preview-panel-v085";
const BUILD_LABEL = "0.8.5 · workflow-polish";
const EMPTY_FILTER = {
    ...
    return `<style>
      ...
      * { box-sizing: border-box; }
      ...
      @media (max-width: 620px) {
        ...
        .filterReset, .bridgeActions button, .actionRow button { width: 100%; white-space: normal; }
